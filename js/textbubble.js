...
// 代表メッセージ 2				 
            , function() {
                ...
                }, [e("p", [this._v("\n  私たちは本質を目的に合わせて、デザインというカタチで感動を与えることを使命だと感じています。"),

                      e("p", [this._v("\n        みえないもの。感じるもの。「みえないもの」を「感じるもの」にするCreative Solutionをご提案します。ＳＮＳなどの普及やそれらを閲覧するスマートフォンなど技術の進歩は益々加速しています。 \n       "),  
                       e("p", [this._v("\n        ＷＥＢも無料や格安で作成できるツールの出現など、簡単にクリエイティブが可能になっています。ただ、人の感性や感動などの本質は変わりません。        \n      "),     
                        e("p", [this._v("\n        私たちはそこを大切にし、人と人を繋ぐことができるような制作を心掛けます。私達を支えていただいた皆様に感謝し、理念に基づき行動します。今後も 多大なご支援を賜りますようお願い申しあげます。        \n      "),
                    ])])])])])
            }
...
// 代表メッセージ callout 3		  
            ...
            , function() {
                ...
                return e("div", {
                    staticClass: "callout__body"
                }, [e("p", [this._v("\n          「喜び」とはお客様が、私たちのサービスを通じて喜んでくれることや幸せを感じてくれることであり、そうなることでスタッフ全員が当社で良かったと喜んでくれる。そして「幸せ」を感じてくれることです。\n        "),
                    e("p", [this._v("\n        その為には        \n      "),
                    e("p", [this._v("\n        ・みんなで経営、みんなが経営者        \n      "),
                    e("p", [this._v("\n        ・知識、技術の幅を拡げ、深く追求し基本価値を高める        \n      "),
                    e("p", [this._v("\n        ・問題を解決し続け、付加価値を高める以上を常に意識して追求し続けることが大切だと考えています。        \n      "),
                        ])])])])])])
            }
